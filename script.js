...
function displayItems() {
    const itemsFromStroage = getItemsFromStroage();
    itemsFromStroage.forEach(item => addItemToDOM(item));
    checkUI();
}
...
function addItemToStroage(item){
    const itemFromStroage = getItemsFromStroage();

    // Aad new item to Array
    itemFromStroage.push(item);

    // Convert to JSON strig and set local storage
